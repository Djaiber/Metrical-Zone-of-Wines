...
-- ------------------------------------------------------------
CREATE FUNCTION fn_calculate_vintage_age(p_vintage_year YEAR) 
RETURNS INT
DETERMINISTIC
BEGIN
...
-- ------------------------------------------------------------
CREATE FUNCTION fn_get_vineyard_age(p_founded_year YEAR) 
RETURNS INT
DETERMINISTIC
BEGIN
    DECLARE v_current_year INT;
...
-- ------------------------------------------------------------
CREATE FUNCTION fn_format_wine_label(p_name VARCHAR(150), p_vintage YEAR, p_alcohol DECIMAL(4,2)) 
RETURNS VARCHAR(255)
DETERMINISTIC
BEGIN
